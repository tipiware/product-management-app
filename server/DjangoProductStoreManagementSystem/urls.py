...
from DjangoRecordApp import views
from DjangoRecordApp.views import CompanyNameViewSet, CompanyOnlyViewSet,MedicineByNameViewSet
from DjangoProductStoreManagementSystem import settings
